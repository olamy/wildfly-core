...
public class CliCapabilityCompletionTestCase {
    ...
    public void testDynamicRequirements() throws Exception {
        ...
        List<ModelNode> elements = result.require("attributes").require("interface").require("capability-reference-pattern-elements").asList();
        assertEquals(1, elements.size());
        assertEquals("We should have an interface capability requirement", "interface", elements.get(0).asString());
