...
public class SnapshotTakeHandler implements OperationStepHandler {
    ...
    private static final AttributeDefinition COMMENT = SimpleAttributeDefinitionBuilder.create(DESCRIPTION, ModelType.STRING, true).setNullSignificant(true).build();
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        String comment = commentNode.isDefined() ? commentNode.asString() : null;
        String snapshot = snapshotNode.isDefined() ? snapshotNode.asString() : null;
        try {
