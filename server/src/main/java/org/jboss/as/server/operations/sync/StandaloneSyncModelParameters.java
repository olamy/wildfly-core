 ...
 */
public class StandaloneSyncModelParameters extends SyncModelParameters {

    private final SynchronizationService syncService;
    private final PathManager pathManager;

    public StandaloneSyncModelParameters(SynchronizationService syncService, ExpressionResolver expressionResolver,
