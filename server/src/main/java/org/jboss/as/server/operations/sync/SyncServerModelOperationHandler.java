 ...
 */
class SyncServerModelOperationHandler extends SyncModelOperationHandler {

    protected SyncServerModelOperationHandler(List<ModelNode> localOperations, Resource remoteModel, Set<String> missingExtensions,
    ...
    protected Node createRemoteRoot(OperationContext context) {
        ...
        final ModelNode response = ((StandaloneSyncModelParameters)parameters).readRemoteOperations();
