...
/**
 * Synchronize the current server configuration with the target reference standalone instance.
 * dry-run allows the synchronization to be computed but not applied.
