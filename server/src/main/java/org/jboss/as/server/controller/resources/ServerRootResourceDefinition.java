...
import org.jboss.as.server.operations.sync.ReadServerModelHandler;
...
public class ServerRootResourceDefinition extends SimpleResourceDefinition {
    ...
    public void registerOperations(ManagementResourceRegistration resourceRegistration) {
        ...
        if (!isDomain) {
            ...
            resourceRegistration.registerOperationHandler(ReadServerModelHandler.DEFINITION, new ReadServerModelHandler(false));
